...
<body>
	<nav class="navbar navbar-expand-md fixed-top bg-light">
      <a class="navbar-brand" href="index.html"><img src="images/BA2016.png" width="233" height="60" alt=""/></a>
...
<div class="container">
  <header>
    <div class="primary_header">
       <h1 class="title">Centro Ángel Gallardo</h1>
    </div>
	...
	<h3>¿Tenes preguntas? Mandanos un mensaje </h3>
	<article>
...
<br>
<label>Mensaje</label>
<textarea name="mensaje" cols="8" rows="5"></textarea>
<br>


<input name="Enviar" type="submit" value="enviar" id = "enviar">

<input name="Restablecer" type="reset" value="reset" id = "reset">
</form>
    </article>
    ...
    <div class="copyright">&copy;2019 - <strong>SIMPLE Theme</strong></div>
	 ...
	 <!-- FOOTER -->
      ...
      <div id= "pie" bg-light>
        ...
        <p>&copy; 2019 &middot; Dirección:<a href="#"> Av. Ángel Gallardo 246/250-Caballito-CABA</a> &middot; Teléfono: 4863-2923 &middot; Horario: Lunes a Viernes de 18hs a 21hs&middot;</p>
      </div>
	
	<!--scripts para bootstrap porque si no lo tenes descargado en la pc no te funciona nada (con DW no hace falta ponerlo-->
