...
$search = $_GET['taller'];
$sql = "SELECT id, nombre, descripcion FROM talleres WHERE nombre LIKE '%".$search."%'";
$search_result = $link->query($sql);
include_once '../../app/Conexion.inc.php';
include_once '../../app/Repositorio_Usuario.inc.php';	
include_once '../../app/ControlSesion.inc.php';
include_once '../../app/config.inc.php';
$titulo= 'Lista Talleres';
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card" style="margin-top: 20px;margin-bottom: 20px;">
                    <div class="card-body">
                        <h2 class="pull-left">Lista de talleres <a href="createTaller.php" class="btn btn-success pull-right">Agregar un taller</a></h2>
                        <form action="Tallearch.php" method="GET">
                                <input name="taller" id="search" type="text" placeholder="nombre taller">
                ...
                if ($search_result->num_rows > 0) {
                        ...
                        while ($row = $search_result->fetch_assoc()) {
                            ...
                            echo "<td>";
                            echo "<a href='readTaller.php?id_taller=" . $row['id'] . "' class='btn btn-primary'>Leer</a>";
                            echo "<a href='updateTaller.php?id_taller=" . $row['id'] . "' class='btn btn-info'>Modificar</a>";
                            echo "<a href='deleteTaller.php?id_taller=" . $row['id'] . "' class='btn btn-danger'>Eliminar</a>";
                            echo "</td>";
                            echo "</tr>";
                        }
                        echo "</tbody>";
                        ...
                        echo "<p class='lead'><em>no se encontraron talleres.</em></p>";
                    }
                $link->close();
                ?>
            </div>
