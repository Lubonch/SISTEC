...
if (isset($_POST['enviar_email'])) {
	...
	$usuario = RepositorioUsuario :: get_usuario_email(Conexion :: obtener_conexion(), $email);
	...
	$peticion_generada = RepositorioRecuperacionClave :: generar_peticion(Conexion :: obtener_conexion(), $usuario -> get_id(), $url_secreta);
